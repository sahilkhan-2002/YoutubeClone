...
return()=>{
  ...
  return (
    <div className='bg-white borde grid justify-between fixed grid-flow-col p-2 shadow-lg items-center   px-2 md:px-4   w-full z-50'>
        <div className='flex items-center col-span-1 md:ml-3 gap-2 md:gap-8'>
 ...
 <img className="h-10 md:hidden" src="https://th.bing.com/th/id/OIP.zjMhUcihfwmLxS5W3NBpMgHaHa?w=180&h=180&c=7&r=0&o=5&dpr=1.7&pid=1.7" alt="" />
    ...
    <div className='col-span-10 items-center'>
      ...
      <input placeholder='Search for a Video' className='lg:w-2/3 border border-gray-400 focus:bg-gray-200 p-2 rounded-l-full  md:px-4 md:py-2:w-96 outline-blue-200' type='text' value={searchQuery} onChange={(e)=>setSearchquery(e.target.value)}
